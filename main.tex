...
% === Contact ===
    ...
    \raisebox{-0.4em}{\includegraphics[width=1.2em]{discord_icon.png}} | @predic02
...
% === AWARDS ===
        ...
        \vspace{1mm}
        \begin{list2}
          \item \textbf{8th}, 2025 Defcon 33 Quals (Team Cold Fusion)
...
% === Projects ===
    ...
    \vspace{2mm}
                ...
                \item[WHS 3rd assistant] \hfill \textsl{March 2025-April 2025}}\\
  	      		\faGithub\space\href{https://github.com/minchan02/WarGame}{my-haf-chall}
 			\vspace{2mm}
    \end{description}
    \vspace{2cm} 
